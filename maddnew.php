...
{
  if (!$con->query("insert into useraccounts (name,cnic,accountNo,accountType,city,address,email,password,balance,source,number,panNo,branch,nationName) values ('$_POST[name]','$_POST[cnic]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[panNo]','$_POST[branch]','$_POST[nationName]')")) {
    ...
    <table class="table ">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <select class="form-control input-sm" name="accountType" required>
              ...
              <option value="recurring deposit" selected>Recurring Deposit</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <th>Pan Number</th>
          <td><input type="text" name="panNo" class="form-control input-sm" required></td>
        </tr>
      <tr>
          <th>Branch</th>
          <td>
          ...
          <th>Nationality</th>
          <td><input type="text" name="nationName" class="form-control input-sm" required></td>
        </tr>
        
        <tr>
          <td colspan="4">
            <button type="submit" name="saveAccount" class="btn btn-primary btn-sm">Save Account</button>
            <button type="Reset" class="btn btn-danger btn-sm">Reset</button></form>
          </td>
        </tr>
      </tbody>
    </table>
