...
<head>
	...
	session_start();
		...
		if (isset($_POST['managerLogin']))
		{
		    ...
		    {
		      $error = "<div class='alert alert-warning text-center rounded-0'>Username or password is incorrect try again!</div>";
		    }
		}

	 ?>
</head>
<body style="background: url(images/bank6.jpg);background-size: 100%">
<h1 class="alert alert-dark bg-gradient-dark rounded-0"><?php echo bankname; ?></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowWhite" style="margin-right: 222px">
    ...
    <div class="card-header" role="tab" id="headingOne">
      <h5 class="mb-0">
        <a style="text-decoration: none;" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <button class="collapsed btn btn-inline-dark btn-block">Customer Login</button>
        </a>
      </h5>
    </div>
  ...
  <div class="card rounded-0">
    <div class="card-header" role="tab" id="headingTwo">
	  ...
	  <a style="text-decoration: none;" data-toggle="collapse" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
         <button class="collapsed btn btn-inline-dark btn-block">Admin Login</button>
        </a>
      </h5>
    </div>
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	...
       	<button type="submit" class="btn btn-dark btn-block btn-sm my-1" name="managerLogin">Enter </button>
       </form>
      </div>
    </div>
  </div>
  <div class="card rounded-0">
    <div class="card-header" role="tab" id="headingThree">
      <h5 class="mb-0">
	  <a style="text-decoration: none;" data-toggle="collapse" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
         <button class="collapsed btn btn-inline-dark btn-block">Employee Login</button>
        </a>
      </h5>
    </div>
